...
# spins. The noise is characterized by a spectral density with a single ohmic
# component, and the coupling between the spin and the environment is constant
# in time. The following code specifies the bath model components as described
# above.
