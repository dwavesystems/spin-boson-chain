...
:math:`\hat{\sigma}_{y; r=0}`, and :math:`\hat{\sigma}_{z; r=0}`.
...
# component of the spin. The noise is characterized by a spectral density with a
...
tensor[0, 0, 0] = 1  # Set sz=1 amplitude to 1.
node = tn.Node(tensor)
