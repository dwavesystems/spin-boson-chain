...
print("    _map_btwn_site_indices_and_unique_local_model_cmpnt_sets =",
...
y_coupling_energy_scale_2 = Scalar(linear_fn, y_func_kwargs_2)
y_coupling_energy_scale_3 = const_scalar
y_coupling_energy_scale_4 = Scalar(linear_fn, y_func_kwargs_2)
y_coupling_energy_scale_5 = const_scalar

y_coupling_energy_scales = [y_coupling_energy_scale_1,
                            y_coupling_energy_scale_2,
                            y_coupling_energy_scale_3,
                            y_coupling_energy_scale_4,
                            y_coupling_energy_scale_5]

z_func_kwargs_2 = {"a": -4.0, "b": 2.0}

z_coupling_energy_scale_1 = 2*const_scalar
z_coupling_energy_scale_2 = Scalar(linear_fn, z_func_kwargs_2)
z_coupling_energy_scale_3 = 2*const_scalar
z_coupling_energy_scale_4 = Scalar(linear_fn, z_func_kwargs_2)
z_coupling_energy_scale_5 = 2*const_scalar

z_coupling_energy_scales = [z_coupling_energy_scale_1,
                            z_coupling_energy_scale_2,
                            z_coupling_energy_scale_3,
                            z_coupling_energy_scale_4,
                            z_coupling_energy_scale_5]
...
A_y_0_0T = 0
A_y_1_0T = bath.SpectralDensity0T(cmpnts=[A_y_r_0T_1, A_y_r_0T_2])
A_y_2_0T = bath.SpectralDensity0T(cmpnts=[A_y_r_0T_1])
A_y_3_0T = bath.SpectralDensity0T(cmpnts=[A_y_r_0T_1, A_y_r_0T_2])
A_y_4_0T = bath.SpectralDensity0T(cmpnts=[A_y_r_0T_1])

y_spectral_densities_0T = [A_y_0_0T, A_y_1_0T, A_y_2_0T, A_y_3_0T, A_y_4_0T]
...
z_spectral_densities_0T = [A_z_0_0T, A_z_1_0T, A_z_2_0T, A_z_3_0T, A_z_4_0T]

print("Constructing an instance of bath.Model.\n")

bath_model = bath.Model(L=5,
                        beta=beta,
                        memory=0.5,
                        y_coupling_energy_scales=y_coupling_energy_scales,
                        z_coupling_energy_scales=z_coupling_energy_scales,
...
# bath.Model test #17.
print("bath.Model test #17")
print("===================")

print("Constructing an instance of bath.Model.\n")

bath_model = bath.Model(L=5, beta=beta, memory=0.5)
...
# bath.noise_strength test #1.
print("bath.noise_strength test #1")
print("===========================")
...
print("Calculate noise strength from spectral density:")
print("    W =", bath.noise_strength(A_z_r_0T_LF))
print("\n\n")



# bath.noise_strength test #2.
print("bath.noise_strength test #2")
print("===========================")

print("Constructing an instance of bath.SpectralDensity0T.\n")
...
print("Calculate noise strength from spectral density:")
print("    W =", bath.noise_strength(A_z_r_0T))
print("\n\n")



# bath.noise_strength test #3.
print("bath.noise_strength test #3")
print("===========================")

print("Constructing an instance of bath.SpectralDensity with two components.\n")

beta = 10.738319368297645
A_z_r_T = bath.SpectralDensity(limit_0T=A_z_r_0T, beta=beta)

print("Calculate noise strength from spectral density:")
print("    W =", bath.noise_strength(A_z_r_T))
print("\n\n")



# bath.noise_strength test #4.
print("bath.noise_strength test #4")
print("===========================")

print("Constructing an instance of bath.SpectralDensityCmpnt.\n")

print("Calculate noise strength from spectral density:")
print("    W =", bath.noise_strength(A_z_r_T.cmpnts[0]))
